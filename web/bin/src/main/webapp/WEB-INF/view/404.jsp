...
<title>404 Page Not Found | niconico comment</title>
<link rel="shortcut icon" href="${f:url('/img/favicon.ico')}" />
<body>
	<div id="main" class="container">
		<h1 class="logo-font" style="text-align: center; margin-bottom: 50px;">
			<span class="color-accent">4</span>0<span class="color-accent">4</span>
		</h1>
		<p class="logo-font" style="text-align: center; margin-bottom: 50px; font-size: 25px;">
			<span style="">Sorry... We can't Find Page.</span>
		</p>
	</div>
</body>